...
var KTCardsWidget10 = {
    init: function() {
        ! function() {
            ...
            if (e) {
                var t = { size: e.getAttribute("data-kt-size") ? parseInt(e.getAttribute("data-kt-size")) : 70, lineWidth: e.getAttribute("data-kt-line") ? parseInt(e.getAttribute("data-kt-line")) : 11, rotate: e.getAttribute("data-kt-rotate") ? parseInt(e.getAttribute("data-kt-rotate")) : 145 },
                ...
                var i = (t.size - t.lineWidth) / 2,
                    s = function(e, t, a) { a = Math.min(Math.max(0, a || 1), 1), o.beginPath(), o.arc(0, 0, i, 0, 2 * Math.PI * a, !1), o.strokeStyle = e, o.lineCap = "round", o.lineWidth = t, o.stroke() };
                s("#E4E6EF", t.lineWidth, 1), s(KTUtil.getCssVariableValue("--bs-danger"), t.lineWidth, 100 / 150), s(KTUtil.getCssVariableValue("--bs-success"), t.lineWidth, .4)
            }
        }()
    }
};
        ...
        ! function() {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    o = new ApexCharts(e, { series: [{ name: "Başvurular", data: [35, 25, 45, 15, 60, 50, 57, 35, 70, 40, 45, 25, 45, 30, 70] }], chart: { fontFamily: "inherit", type: "area", height: t, toolbar: { show: !1 } }, legend: { show: !1 }, dataLabels: { enabled: !1 }, fill: { type: "solid", opacity: 0 }, stroke: { curve: "smooth", show: !0, width: 2, colors: [a] }, xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1 }, crosshairs: { position: "front", stroke: { color: a, width: 1, dashArray: 3 } }, tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px" } } }, yaxis: { labels: { show: !1 } }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, x: { formatter: function(e) { return "Impression " + e } }, y: { formatter: function(e) { return "$" + e + " thousands" } } }, colors: [r], grid: { strokeDashArray: 4, padding: { top: 0, right: -20, bottom: -20, left: -20 }, yaxis: { lines: { show: !0 } } }, markers: { strokeColor: a, strokeWidth: 2 } });
...
var KTTablesWidget3 = function() {
    ...
    const a = () => {
        ...
        $(e).on("select2:select", (function(e) { const a = $(this).val(); "Show All" === a ? t.search("").draw() : t.search(a).draw() }))
    };
    return {
        init: function() {
            (e = document.querySelector("#kt_widget_table_3")) && (t = $(e).DataTable({ info: !1, order: [], paging: !1, pageLength: !1 }), (() => {
                ...
                e.forEach((r => {
                    r.addEventListener("click", (o => {
                        ...
                        e.forEach((e => { e.classList.remove(...a), e.classList.add("text-muted") })), r.classList.remove("text-muted"), r.classList.add(...a), "Show All" === i ? t.search("").draw() : t.search(i).draw()
                    }))
                }))
            })(), a())
        }
...
var KTTablesWidget4 = function() {
    ...
    return {
        init: function() {
            ...
            })(), document.querySelector('[data-kt-table-widget-4="search"]').addEventListener("keyup", (function(e) { t.search(e.target.value).draw() })), r(), i())
        }
    }
}();
...
var KTTablesWidget5 = function() {
    ...
    return {
        init: function() {
            ...
            })), t = $(e).DataTable({ info: !1, order: [], lengthChange: !1, pageLength: 6, paging: !1, columnDefs: [{ orderable: !1, targets: 1 }] }), a())
        }
    }
}();
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    r.mapPolygons.template.setAll({ tooltipText: "{name}", toggleKey: "active", interactive: !0, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")) }), r.mapPolygons.template.states.create("hover", { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) }), r.mapPolygons.template.states.create("active", { fill: am5.color(KTUtil.getCssVariableValue("--bs-success")) });
                    var o = a.series.push(am5map.MapPolygonSeries.new(t, { geoJSON: am5geodata_worldLow, include: ["US", "BR", "RU"] }));
                    o.mapPolygons.template.setAll({ tooltipText: "{name}", toggleKey: "active", interactive: !0 }), am5.ColorSet.new(t, {}), o.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))), o.mapPolygons.template.states.create("hover", { fill: t.interfaceColors.get("primaryButtonHover") }), o.mapPolygons.template.states.create("active", { fill: t.interfaceColors.get("primaryButtonHover") }), a.chartContainer.get("background").events.on("click", (function() { a.goHome() })), a.appear(1e3, 100)
                }))
            }
        }()
    }
...
var KTChartsWidget12 = function() {
    var e = function(e, t, a, r) {
        ...
        if (o) {
            var i = parseInt(KTUtil.css(o, "height")),
                s = (KTUtil.getCssVariableValue("--bs-gray-900"), KTUtil.getCssVariableValue("--bs-border-dashed-color")),
                l = { series: [{ name: "Net Profit", data: a }], chart: { fontFamily: "inherit", type: "bar", height: i, toolbar: { show: !1 } }, plotOptions: { bar: { horizontal: !1, columnWidth: ["22%"], borderRadius: 5, dataLabels: { position: "top" }, startingShape: "flat" } }, legend: { show: !1 }, dataLabels: { enabled: !0, offsetY: -28, style: { fontSize: "13px", colors: ["labelColor"] } }, stroke: { show: !0, width: 2, colors: ["transparent"] }, xaxis: { categories: ["Grossey", "Pet Food", "Flowers", "Restaurant", "Kids Toys", "Clothing", "Still Water"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px" } }, crosshairs: { fill: { gradient: { opacityFrom: 0, opacityTo: 0 } } } }, yaxis: { labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px" }, formatter: function(e) { return parseInt(e) + "K" } } }, fill: { opacity: 1 }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px" }, y: { formatter: function(e) { return "$" + e + " thousands" } } }, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-light-primary")], grid: { borderColor: s, strokeDashArray: 4, yaxis: { lines: { show: !0 } } } },
                n = new ApexCharts(o, l),
                d = !1,
                c = document.querySelector(e);
            !0 === r && (n.render(), d = !0), c.addEventListener("shown.bs.tab", (function(e) { 0 == d && (n.render(), d = !0) }))
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    var r = [{ year: "2003", cars: 1587, motorcycles: 650, bicycles: 121 }, { year: "2004", cars: 1567, motorcycles: 683, bicycles: 146 }, { year: "2005", cars: 1617, motorcycles: 691, bicycles: 138 }, { year: "2006", cars: 1630, motorcycles: 642, bicycles: 127 }, { year: "2007", cars: 1660, motorcycles: 699, bicycles: 105 }, { year: "2008", cars: 1683, motorcycles: 721, bicycles: 109 }, { year: "2009", cars: 1691, motorcycles: 737, bicycles: 112 }, { year: "2010", cars: 1298, motorcycles: 680, bicycles: 101 }, { year: "2011", cars: 1275, motorcycles: 664, bicycles: 97 }, { year: "2012", cars: 1246, motorcycles: 648, bicycles: 93 }, { year: "2013", cars: 1318, motorcycles: 697, bicycles: 111 }, { year: "2014", cars: 1213, motorcycles: 633, bicycles: 87 }, { year: "2015", cars: 1199, motorcycles: 621, bicycles: 79 }, { year: "2016", cars: 1110, motorcycles: 210, bicycles: 81 }, { year: "2017", cars: 1165, motorcycles: 232, bicycles: 75 }, { year: "2018", cars: 1145, motorcycles: 219, bicycles: 88 }, { year: "2019", cars: 1163, motorcycles: 201, bicycles: 82 }, { year: "2020", cars: 1180, motorcycles: 285, bicycles: 87 }, { year: "2021", cars: 1159, motorcycles: 277, bicycles: 71 }],
                        o = a.xAxes.push(am5xy.CategoryAxis.new(t, { categoryField: "year", startLocation: .5, endLocation: .5, renderer: am5xy.AxisRendererX.new(t, {}), tooltip: am5.Tooltip.new(t, {}) }));
                    o.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }), o.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }), o.data.setAll(r);
                    var i = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));

                    function s(e, s, l) {
                        var n = a.series.push(am5xy.LineSeries.new(t, { name: e, xAxis: o, yAxis: i, stacked: !0, valueYField: s, categoryXField: "year", fill: am5.color(l), tooltip: am5.Tooltip.new(t, { pointerOrientation: "horizontal", labelText: "[bold]{name}[/]\n{categoryX}: {valueY}" }) }));
                        n.fills.template.setAll({ fillOpacity: .5, visible: !0 }), n.data.setAll(r), n.appear(1e3)
                    }
                    i.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }), i.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }), s("Cars", "cars", KTUtil.getCssVariableValue("--bs-primary")), s("Motorcycles", "motorcycles", KTUtil.getCssVariableValue("--bs-success")), s("Bicycles", "bicycles", KTUtil.getCssVariableValue("--bs-warning")), a.set("scrollbarX", am5.Scrollbar.new(t, { orientation: "horizontal", marginBottom: 25, height: 8 }));
                    var l = o.makeDataItem({ category: "2016", endCategory: "2021" });
                    o.createAxisRange(l), l.get("grid").setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-200")), strokeOpacity: .5, strokeDasharray: [3] }), l.get("axisFill").setAll({ fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-200")), fillOpacity: .1 }), l.get("label").setAll({ inside: !0, text: "Fines increased", rotation: 90, centerX: am5.p100, centerY: am5.p100, location: 0, paddingBottom: 10, paddingRight: 15 });
                    var n = o.makeDataItem({ category: "2021" });
                    o.createAxisRange(n), n.get("grid").setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-danger")), strokeOpacity: 1, strokeDasharray: [3] }), n.get("label").setAll({ inside: !0, text: "Fee introduced", rotation: 90, centerX: am5.p100, centerY: am5.p100, location: 0, paddingBottom: 10, paddingRight: 15 }), a.appear(1e3, 100)
                }))
            }
        }()
    }
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    s.labels.template.setAll({ centerX: am5.p100, fontWeight: "500", fontSize: 18, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")), templateField: "columnSettings" }), s.grid.template.setAll({ forceHidden: !0 });
                    ...
                    n.columns.template.setAll({ width: am5.p100, fillOpacity: .08, strokeOpacity: 0, cornerRadius: 20 }), n.data.setAll(r);
                    ...
                    d.columns.template.setAll({ width: am5.p100, strokeOpacity: 0, tooltipText: "{category}: {valueX}%", cornerRadius: 20, templateField: "columnSettings" }), d.data.setAll(r), n.appear(1e3), d.appear(1e3), a.appear(1e3, 100)
                }))
            }
        }()
    }
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    var i = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));
                    i.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] }), i.get("renderer").labels.template.setAll({ fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) });
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    o.get("renderer").labels.template.setAll({ paddingTop: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }), o.get("renderer").grid.template.setAll({ disabled: !0, strokeOpacity: 0 }), o.data.setAll(r);
                    var i = a.yAxes.push(am5xy.ValueAxis.new(t, { renderer: am5xy.AxisRendererY.new(t, {}) }));
                    i.get("renderer").labels.template.setAll({ paddingLeft: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")) }), i.get("renderer").grid.template.setAll({ stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3] });
                    ...
                    n.columns.template.setAll({ tooltipText: "{categoryX}: {valueY}", tooltipY: 0, strokeOpacity: 0, cornerRadiusTL: 6, cornerRadiusTR: 6 }), n.columns.template.adapters.add("fill", (function(e, t) { return a.get("colors").getIndex(n.dataItems.indexOf(t.dataItem)) }));
                    ...
                    d.bullets.push((function() { return am5.Bullet.new(t, { locationY: 1, sprite: am5.Circle.new(t, { radius: 5, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), stroke: am5.color(KTUtil.getCssVariableValue("--bs-dark")) }) }) })), n.data.setAll(r), d.data.setAll(r), n.appear(), a.appear(1e3, 100)
                }))
            }
        }()
    }
        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    var t = am5.Root.new(e);
                    t.setThemes([am5themes_Animated.new(t)]);
                    var a = t.container.children.push(am5percent.PieChart.new(t, { startAngle: 180, endAngle: 360, layout: t.verticalLayout, innerRadius: am5.percent(50) })).series.push(am5percent.PieSeries.new(t, { startAngle: 180, endAngle: 360, valueField: "value", categoryField: "category", alignLabels: !1 }));
